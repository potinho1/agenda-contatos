...
from .forms import EditarContatoForm, NovoEmailForm, NovoGrupoForm, NovoTelForm
...
def editar_contato(request, contato_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('contato_list_view')
